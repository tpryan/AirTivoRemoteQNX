package com.terrenceryan.tivoremote
{
	...
	public class TivoService
	{
		...
		private var _tivos:Array = new Array();
		...
		public function get tivos():Array
		{
			return _tivos;
		}

		private function set tivos(value:Array):void
		{
			_tivos = value;
		}
		...
		public function getItemForID(id:int):Tivo
		{
			var tivo:Tivo = _tivos[id-1];
